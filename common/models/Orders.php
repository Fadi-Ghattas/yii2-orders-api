		...
		return ArrayHelper::merge(
			...
			[
				...
				self::SCENARIO_ORDER_DETAILS => [
					...
					'vouchers' => function () {
						return (!empty($this->voucher) ? $this->voucher->getVoucherFields() : $this->voucher);
					},
					...
					'order_items' => function () {
						...
						foreach ($this->orderItems as $orderItem) {
							$singleOrderItem = [];
							$singleOrderItem['order_item_id'] = $orderItem->id;
							...
							$singleOrderItem['item_choices'] = (!empty($orderItem->orderItemChoices) ? $orderItem->orderItemChoices : NULL);
